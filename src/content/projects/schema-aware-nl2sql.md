...
detail: >-
  Fine-tuned T5 with QLoRA, conditioned on the target schema so it generalises across dynamic
  databases rather than memorising one. Ships both a web interface and a REST API.
stack:
  - 'Python'
  - 'T5'
  - 'QLoRA'
